            ...
            <div class="row align-items-center">
              <div class="col-lg-4 ml-auto">
                <div class="ex-page-content">
                  ...
                  <h4 class="mb-4">الرقم 404 يعني أن تلك الصفحة غير موجودة</h4>
                  <p
                    class="mb-5"
                  >تلك الصفحة غير موجودة بسبب أنك دخلت إلى عنوان غير مُسجل عندنا</p>
                  <router-link tag="a" class="btn btn-primary mb-5" to="/">
                    <i class="mdi mdi-home"></i> العودة إلى لوحة التحكم
                  </router-link>
                </div>
              </div>
